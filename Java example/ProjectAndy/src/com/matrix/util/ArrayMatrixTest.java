...
public class ArrayMatrixTest {
  ...
  public void testGetNumberOfRowsForSizeConstructor() throws MatrixException {
    Matrix<Double> matrix = new ArrayMatrix<>(3, 4);
    assertEquals(3, matrix.getNumberOfRows());
  }

  @Test
  public void testGetNumberOfRowsForContentsConstructor() throws MatrixException {
    Matrix<Double> matrix = new ArrayMatrix<>(new Double[][] { new Double[] { 1. }, new Double[] { 1. } });
  ...
  public void testSetElementInvalidPosition() throws MatrixException {
    Matrix<Double> matrix = new ArrayMatrix<>(1, 1);
  ...
  public void testAddDifferentSizes() throws MatrixException {
    Matrix<Double> first = new ArrayMatrix<>(2, 2);
    Matrix<Double> second = new ArrayMatrix<>(3, 4);
    first.add(second);
  }

  @Test
  public void testAddHappyFlow() throws MatrixException {
    Matrix<Double> first = new ArrayMatrix<>(firstInput);
    Matrix<Double> second = new ArrayMatrix<>(secondInput);
