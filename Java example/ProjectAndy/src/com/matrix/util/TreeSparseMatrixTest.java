...
public class TreeSparseMatrixTest {
  ...
  public void testGetNumberOfRowsForSizeConstructor() throws MatrixException {
    Matrix<Double> matrix = new TreeSparseMatrix<>(3, 4);
    assertEquals(3, matrix.getNumberOfRows());
  }

  @Test
  public void testGetNumberOfRowsForContentsConstructor() throws MatrixException {
    Matrix<Double> matrix = new TreeSparseMatrix<>(new Double[][] { new Double[] { 1. }, new Double[] { 1. } });
  ...
  public void testSetElementInvalidPosition() throws MatrixException {
    Matrix<Double> matrix = new TreeSparseMatrix<>(1, 1);
  ...
  public void testAddDifferentSizes() throws MatrixException {
    Matrix<Double> first = new TreeSparseMatrix<>(2, 2);
    Matrix<Double> second = new TreeSparseMatrix<>(3, 4);
    first.add(second);
  }

  @Test
  public void testAddHappyFlow() throws MatrixException {
    Matrix<Double> first = new TreeSparseMatrix<>(firstInput);
    Matrix<Double> second = new TreeSparseMatrix<>(secondInput);
